...
$s->configureWSDL('SECwsdl', 'http://sec.ts.astro.it/sec_server.php');
    
	$s->register('sql',
    array('name' => 'xsd:string'),        // input parameters
    array('return' => 'xsd:string'),      // output parameters
    'urn:sec_server.php',                      // namespace
    'urn:sec_server.php#sql',                // soapaction
    'document',                                // style
    'literal',                            // use
    'sql:See SEC documentation. '            // documentation
);
	$s->register('describeCatalogue',
    array('name' => 'xsd:string'),        // input parameters
    array('return' => 'xsd:string'),      // output parameters
    'urn:sec_server.php',                      // namespace
    'urn:sec_server.php#describeCatalogue',                // soapaction
    'document',                                // style
    'literal',                            // use
    'describeCatalogue:See SEC documentation. '            // documentation
);
	$s->register('describeTable',
    array('name' => 'xsd:string'),        // input parameters
    array('return' => 'xsd:string'),      // output parameters
    'urn:sec_server.php',                      // namespace
    'urn:sec_server.php#describeTable',                // soapaction
    'document',                                // style
    'literal',                            // use
    'describeTable:See SEC documentation. '            // documentation
);
	$s->register('countRows',
    array('name' => 'xsd:string'),        // input parameters
    array('return' => 'xsd:string'),      // output parameters
    'urn:sec_server.php',                      // namespace
    'urn:sec_server.php#countRows',                // soapaction
    'document',                                // style
    'literal',                            // use
    'countRows:See SEC documentation. '            // documentation
);
